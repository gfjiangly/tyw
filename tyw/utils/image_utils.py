...
def draw_class_distribution(y, save_path='class_distribution.png'):
    """绘制饼图,其中y是标签列表
    """
...
def draw_dataframe(data, dst, col, im_size=(20 * 4, 5), show_value=None):
    ...
    # dt = datetime.now()
    # dst = dst + dt.strftime('%Y-%m-%d %H-%M-%S %f') + '.png'
    dst = dst + '.png'
...
def draw_dataframe_fragments(data_list, color_list, dst, col, im_size=None, tick_spacing=None):
    """根据列名选择DataFrame的列，绘制图像
    """
